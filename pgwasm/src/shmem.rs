...
const SHMEM_STATE_NAME: &std::ffi::CStr = c"pgwasm.SharedState";
const CATALOG_LOCK_TRANCHE_NAME: &std::ffi::CStr = c"pgwasm.CatalogLock";
...
/// Bump generation under `pgwasm.CatalogLock` in exclusive mode.
